...
using RobotTools.Editor.TextEditor.Background;
using RobotTools.Editor.TextEditor.Bracket;
using RobotTools.Editor.TextEditor.Completion;
using RobotTools.Editor.TextEditor.IconBar;
using RobotTools.Editor.TextEditor.Options;
using RobotTools.Editor.TextEditor.Snippets;

namespace RobotTools.Editor.TextEditor
{
    public partial class AvalonEditor : ICSharpCode.AvalonEdit.TextEditor, INotifyPropertyChanged,IDocument
...

    {
        ...
        {
            get => _options ?? (_options = new EditorOptions());
        ...
        public static readonly DependencyProperty TextProperty =
            DependencyProperty.Register(nameof(Text), typeof(string), typeof(AvalonEditor), new PropertyMetadata(HandleTextPropertyChanged)); 
        ...
        public static readonly DependencyProperty FilenameProperty =
            DependencyProperty.Register(nameof(Filename), typeof(string), typeof(AvalonEditor), new PropertyMetadata(HandleFilenamePropertyChanged)
            );
